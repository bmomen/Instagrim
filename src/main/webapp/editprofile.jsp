            ...
            <div id="main_wrapper">
                <section id="main_section">
                    <form method="POST"  action="Editprofile">
                        ...
                        <ul>
                            <li>Confirm Username: <input type="text" name="username"></li>
                            <li>Edit Profile Title: <input type="text"  name="profiletitle"></li>
                            <li>Edit Profile Data: <input type="text"  name="profiledata"></li>
                        </ul>
                        <br/>
